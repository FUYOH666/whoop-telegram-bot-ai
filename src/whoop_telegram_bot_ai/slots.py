"""Логика слотов Whoop Telegram Bot AI - определение 6 слотов и эталонного дня."""
...
SLOT_BUTTONS: dict[str, list[tuple[str, str]]] = {
    ...
    "S4": [
        ("✅ Сделал шаг к цели", "success"),
        ("⏭ Пока без шага к цели", "skip"),
    ],
    "S5": [
...
SLOT_DESCRIPTIONS: dict[str, str] = {
    ...
    "S4": "Шаг к цели — один конкретный шаг к достижению цели",
